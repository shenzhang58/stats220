...
avg_budget <- mean(processed_data$Budget)
...
-   Maximum budget: `r paste0(max(processed_data$Budget), "M NZD")`
...
property_summary <- processed_data %>%
  count(Property_Type) %>%
...
ggplot(processed_data, aes(x = Budget)) +
  geom_histogram(
    aes(y = ..density..),
    bins = 15,
    fill = "orange",
